...
latex_documents = [
    (master_doc, "epochs.tex", "epochs Documentation", "Michael Galloy", "manual"),
]
...
man_pages = [(master_doc, "epochs", "epochs Documentation", [author], 1)]
